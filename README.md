...
> [!NOTE]
> If you aren't interested in running the benchmarks yourself, see the [benchmark docs](https://docs.imagor.net/benchmarks) for the summary and charts. The latest committed summaries currently cover the 2026-05-28 AWS rerun, and are available in the [results](results) directory.
